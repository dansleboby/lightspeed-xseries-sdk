 ...
 * [pagination](https://x-series-api.lightspeedhq.com/docs/pagination#api-20) mechanism is not
 * appropriate for this endpoint. Instead, this endpoint uses `offset` and `page_size` attributes to
 * handle search results spanning multiple pages.
 */
class Search extends Request
{
	 ...
	 * @param null|string $orderBy The attribute used to sort items returned in the response.
