...
/**
 * List all products for specific consignment
 */
class ListAllProductsForSpecificConsignment extends Request
{
	...
	{
		return "/api/2.0/consignments/{$this->consignmentId}/products";
	}
