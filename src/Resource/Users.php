...
class Users extends Resource
{
	 ...
	 */
	public function listUsers(?string $before, ?string $pageSize): Response
	{
	 ...
	 * @param string $userId
	 */
	public function getSingleUser(string $userId): Response
	{
		return $this->connector->send(new GetSingleUser($userId));
	}
